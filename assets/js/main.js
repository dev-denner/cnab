...
var CODLOCAL = 'http://intranet-old.grupompe.com.br/cnab/';
...
$('.form_cnab input[name="forma_pagto"]').bind('click', function () {
    var justificativa = $('.form_cnab input[name="forma_pagto"]:checked').val();
    if (justificativa == '10') {
        $("#banco_cnab").attr('required', 'required').parents('.form-group').removeClass('hidden');
    } else {
        $("#banco_cnab").removeAttr('required').parents('.form-group').addClass('hidden');
    }
});