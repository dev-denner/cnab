...
class cnab240 extends MY_Model {
     ...
     *
     * */
    public $tipoInscricaoFavorecido = 1;
    public $numInscricaoFavorecido;
    public $logradouroFavorecido;
    public $numeroFavorecido;
    public $complementoFavorecido;
    public $bairroFavorecido;
    public $cidadeFavorecido;
    public $cepFavorecido;
    public $complementoCepFavorecido;
    public $ufFavorecido;
    ...
    public function headerArquivo() {
        ...
        $linha .= str_pad($this->codConvenioNoBanco, 20, ' ', STR_PAD_RIGHT);
    ...
    public function headerLote() {
        ...
        $linha .= substr(str_pad($this->codConvenioNoBanco, 20, ' ', STR_PAD_RIGHT), 0, 20);
    ...
    public function registro() {
        ...
        $linha .= substr(str_pad($this->numDocEmpresa, 20, ' ', STR_PAD_RIGHT), 0, 20);
        ...
        $linha .= substr(str_pad($this->dataRealEfetivacaoPagto, 8, '0', STR_PAD_RIGHT), 0, 8);
        $linha .= substr(str_pad($this->valorRealEfetivacaoPagto, 15, '0', STR_PAD_RIGHT), 0, 15);
    ...
    public function segmentoB() {
        ...
        $linha .= 'B';
        $linha .= str_pad('', 3, ' ', STR_PAD_RIGHT);
        $linha .= str_pad($this->tipoInscricaoFavorecido, 1, '0', STR_PAD_LEFT);
        $linha .= substr(str_pad($this->numInscricaoFavorecido, 14, '0', STR_PAD_LEFT), 0, 14);
        $linha .= substr(str_pad($this->logradouroFavorecido, 30, ' ', STR_PAD_RIGHT), 0, 30);
        $linha .= substr(str_pad($this->numeroFavorecido, 5, '0', STR_PAD_LEFT), 0, 5);
        $linha .= substr(str_pad($this->complementoFavorecido, 15, ' ', STR_PAD_RIGHT), 0, 15);
        $linha .= substr(str_pad($this->bairroFavorecido, 15, ' ', STR_PAD_RIGHT), 0, 15);
        $linha .= substr(str_pad($this->cidadeFavorecido, 20, ' ', STR_PAD_RIGHT), 0, 20);
        $linha .= substr(str_pad($this->cepFavorecido, 5, '0', STR_PAD_RIGHT), 0, 5);
        $linha .= substr(str_pad($this->complementoCepFavorecido, 3, '0', STR_PAD_RIGHT), 0, 3);
        $linha .= substr(str_pad($this->ufFavorecido, 2, ' ', STR_PAD_RIGHT), 0, 2);
        $linha .= substr(str_pad($this->dataVencimento, 8, '0', STR_PAD_LEFT), 0, 8);
        $linha .= substr(str_pad($this->valorDocumento, 15, '0', STR_PAD_LEFT), 0, 15);
        $linha .= substr(str_pad($this->valorAbatimento, 15, '0', STR_PAD_LEFT), 0, 15);
        $linha .= substr(str_pad($this->valorDesconto, 15, '0', STR_PAD_LEFT), 0, 15);
        $linha .= substr(str_pad($this->valorMora, 15, '0', STR_PAD_LEFT), 0, 15);
        $linha .= substr(str_pad($this->valorMulta, 15, '0', STR_PAD_LEFT), 0, 15);
        $linha .= substr(str_pad($this->codDocumentoFavorecido, 15, ' ', STR_PAD_RIGHT), 0, 15);
        $linha .= str_pad('', 15, ' ', STR_PAD_RIGHT);
    ...
    public function trailerLote() {
        ...
        $linha .= str_pad($this->numAvisoDebito, 6, '0', STR_PAD_LEFT);
